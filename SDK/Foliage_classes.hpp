...
public:
	...
	uint8                                        Pad_296F[0x24];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_297D[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_297E[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2983[0x1F];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2984[0xA0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FProceduralFoliageInstance>    InstancesArray;                                    // 0xD0(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2985[0x78];                                    // Fixing Size Of Struct [ Dumper-7 ]
