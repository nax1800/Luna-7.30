...
public:
	...
	uint8                                        Pad_2A2A[0x50];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2A2B[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2A2C[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
