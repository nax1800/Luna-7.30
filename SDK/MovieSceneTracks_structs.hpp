...
public:
	...
	uint8                                        Pad_F5C[0x2];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_F60[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	struct FVector                               Location;                                          // 0x8(0xC)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                          Time;                                              // 0x14(0x4)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_F62[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_F63[0x140];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               RotationCurve;                                     // 0x1E0(0xA0)(NativeAccessSpecifierPublic)
	uint8                                        Pad_F64[0x140];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               ScaleCurve;                                        // 0x3C0(0xA0)(NativeAccessSpecifierPublic)
	uint8                                        Pad_F65[0x140];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F69[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_F72[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_F73[0x1C];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_F74[0x1E0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F76[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_F77[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_F78[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_F7E[0x1E0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F80[0x67];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
