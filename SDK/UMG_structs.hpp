...
{
public:
	uint8                                        Pad_DC8[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_DC9[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_DCC[0xA0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DCD[0xA0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               Shear;                                             // 0x368(0xA0)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_DCE[0xA0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
