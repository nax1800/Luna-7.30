...
{
public:
	uint8                                        Pad_27A3[0xA8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_27A5[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_27A6[0x30];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_27A7[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_27A8[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_27AA[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_27AB[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_27AD[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
