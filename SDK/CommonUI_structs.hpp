...
public:
	...
	uint8                                        Pad_E4B[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_E4E[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_E50[0x150];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_E52[0x1F8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
