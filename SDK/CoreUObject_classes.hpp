...
{
public:
	uint8                                        Pad_AF[0x10];                                      // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	...
	uint8                                        Pad_B0[0x44];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B1[0x20];                                      // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	enum class EClassCastFlags                   CastFlags;                                         // (0xB8[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_B2[0x40];                                      // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	class UObject*                               DefaultObject;                                     // (0x100[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_B3[0x100];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B4[0x38];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B5[0x28];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B7[0x28];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B8[0x68];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B9[0xB8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_BA[0x10];                                      // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_BD[0x4];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C0[0x1B8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C1[0xC8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C2[0x1B8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C3[0xA0];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_CB[0x18];                                      // Fixing Size Of Struct [ Dumper-7 ]
